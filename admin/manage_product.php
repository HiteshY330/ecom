...
if(isset($_POST['submit'])){
    ...
    //code for image validation

    if ($_FILES['image']['type']!='' && ($_FILES['image']['type']!='image/png' && $_FILES['image']['type']!='image/jpg' && $_FILES['image']['type']!='image/jpeg' )) {
      $msg="Only Select Only png, jpg, jpeg image formate";
    }
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Product<small> Form</small></strong></div>
                        ...
                        echo "<option value=".$row['id'].">".$row['categories']."</option>";
                          ...
                          <div class="form-group">
                            ...
                            <textarea name="short_desc" placeholder="Enter your product name name" class="form-control" required ><?php echo $short_desc ?></textarea>
                          </div>

                          <div class="form-group">
                            <label for="categories" class=" form-control-label">Description</label>
                            <textarea name="description" placeholder="Enter your product name name" class="form-control" required ><?php echo $description ?></textarea>
                          </div>

                          <div class="form-group">
                            <label for="categories" class=" form-control-label">Meta Title</label>
                            <textarea name="meta_title" placeholder="Enter your product meta title" class="form-control" required ><?php echo $meta_title ?></textarea>
                          </div>

                          <div class="form-group">
                            <label for="categories" class=" form-control-label">Meta Description</label>
                            <textarea name="meta_desc" placeholder="Enter your product meta title" class="form-control" required ><?php echo $meta_desc ?></textarea>
                          </div>

                          <div class="form-group">
                            <label for="categories" class=" form-control-label">Meta Keyword</label>
                            <textarea name="meta_keyword" placeholder="Enter your product meta title" class="form-control" required> <?php echo $meta_keyword ?></textarea>
                          </div>
